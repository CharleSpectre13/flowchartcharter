  ...
  return [
    {
      ...
      corporateRank: 1,
      load: 0,
      capability: { extraction: 1, uncertainty: 0.5 },
      talentEligible: true,
      layer: "ops",
    },
    {
      ...
      corporateRank: 1,
      load: 0,
      capability: { validation: 1, uncertainty: 0.5 },
      talentEligible: true,
      layer: "ops",
    },
    {
      ...
      corporateRank: 2,
      load: 0,
      capability: { synthesis: 1, uncertainty: 0.6 },
      talentEligible: true,
      layer: "ops",
    },
    {
      ...
      corporateRank: 4,
      load: 0,
      capability: { audit: 1, uncertainty: 0.4 },
